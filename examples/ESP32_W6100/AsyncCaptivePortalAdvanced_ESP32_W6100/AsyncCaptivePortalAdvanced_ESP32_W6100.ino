/****************************************************************************************************************************
  AsyncCaptivePortalAdvanced_ESP32_W6100.ino
...
/*
   ...
   Now the ESP32_W6100 is in your network. You can reach it through http://192.168.x.x/

   This is a captive portal because it will redirect any http request to http://192.168.x.x/
*/

#if !( defined(ESP32) )
  #error This code is designed for (ESP32 + LwIP W6100) to run on ESP32 platform! Please check your Tools->Board setting.
#endif
